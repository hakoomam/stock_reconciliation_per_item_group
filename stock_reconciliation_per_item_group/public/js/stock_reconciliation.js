frappe.ui.form.on("Stock Reconciliation", {
    ...
    get_items_but_item_group: function(frm) {
		...
		frappe.prompt(fields, function(data) {
			frappe.call({
				method: "stock_reconciliation_per_item_group.stock_reconciliation_per_item_group.tion_per_item_group.stock_reconciliation_per_item_group.controllers.stock_reconciliation_per_item_group.get_items",
				args: {
