frappe.ui.form.on("Stock Reconciliation", {
    ...
    get_items_but_item_group: function(frm) {
		...
		frappe.prompt(fields, function(data) {
			frappe.call({
				method: "stock_reconcialiation_per_item_group.stock_reconcialiation_per_item_group.tion_per_item_group.stock_reconcialiation_per_item_group.controllers.stock_reconcialiation_per_item_group.get_items",
				args: {
